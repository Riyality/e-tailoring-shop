			...
			<div class="row">
				<div class="col-xl-12">
					<div class="card custom-card">
						...
						<div class="card-body">
							<form action="/recipts/addPDetails" method="post">
	<div class="row">
		<div class="col-xl-6">
			<div class="mb-3">
				<label for="pantType" class="form-label">Pant Type</label> 
		...
		<div class="col-xl-6">
			<div class="mb-3">
				<label for="pantPress" class="form-label">Press</label>
		...
		<div class="col-xl-4">
			<div class="mb-2">
				<label for="pantRate" class="form-label">Rate</label> 
		...
		<div class="col-xl-4">
			<div class="mb-2">
				<label for="pantShape" class="form-label">Shape</label> 
				<input type="text" class="form-control" id="pantShape" name="pantShape" placeholder="Shape">
			</div>
		</div>
		
		<div class="col-xl-6">
			<div class="mb-3">
				<label for="pantTip" class="form-label">Tip</label> 
		...
		<div class="col-xl-6">
			<div class="mb-3">
				<label for="pantPocket" class="form-label">Pocket</label> 
		...
		<div>
			<div class="mb-3">
				<label for="pantOther" class="form-label">Other</label> 
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="card custom-card">
						...
						<div class="card-body">
						<form action="/recipts/addSDetail" method="post">
    <div class="row">
        <div class="col-xl-6">
            <div class="mb-3">
        ...
        <div class="col-xl-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="shirtPress" name="shirtPress" placeholder="Shirt Press">
            </div>
        </div>
        <div class="col-xl-4">
            <div class="mb-2">
                <label for="shirtRate" class="form-label">Rate</label> 
        ...
        <div class="col-xl-4">
            <div class="mb-2">
                <label for="shirtShape" class="form-label">Shape</label> 
        ...
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <label for="shirtHeight" class="form-label">Height</label> 
                    <input type="text" class="form-control" id="shirtHeight" name="shirtHeight" placeholder="Height">
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="shirtChest" class="form-label">Chest</label> 
            ...
            <div class="col">
                <div class="mb-3">
                    <label for="shirtHandLoose" class="form-label">Hand Loose</label>
                    <input type="text" class="form-control" id="shirtHandLoose" name="shirtHandLoose" placeholder="Hand Loose">
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="shirtSleeve" class="form-label">Sleeve</label>
                    <input type="text" class="form-control" id="shirtSleeve" name="shirtSleeve" placeholder="Sleeve">
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="shirtSleeveCup" class="form-label">Sleeve Cup</label>
                    <input type="text" class="form-control" id="shirtSleeveCup" name="shirtSleeveCup" placeholder="Sleeve Cup">
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="shirtCollar" class="form-label">Collar</label> 
                    <input type="text" class="form-control" id="shirtCollar" name="shirtCollar" placeholder="Collar">
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="shirtLoose" class="form-label">Loose</label> 
                    <input type="text" class="form-control" id="shirtLoose" name="shirtLoose" placeholder="Loose">
                </div>
            </div>
        </div>
        <div>
            <div class="mb-3">
                <label for="shirtOther" class="form-label">Other Details</label> 
                <input type="text" class="form-control" id="shirtOther" name="shirtOther" placeholder="Other Details">
            </div>
        </div>
        <div class="col-xl-12">
            <button class="btn btn-primary" type="submit">Submit</button>
