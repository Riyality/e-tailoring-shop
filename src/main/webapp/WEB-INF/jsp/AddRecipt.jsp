								...
								<div class="col-xl-6">
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="recipt-no"
											...
											readonly="readonly" value="${receiptMaxId }">
									</div>
								</div>
								<div class="col-xl-6">
									<div class="mb-3">
								...
								<div class="col-xl-4">
									<div class="mb-3">
										<label for="name" class="form-label">Name:</label> <input
											...
											placeholder="Name" value="${customer.name }"> <input
											type="hidden" class="form-control" id="customerId"
											name="customerId" placeholder="Phone No"
											value="${customer.id }">
									</div>
								</div>
								<div class="col-xl-4">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="row">
								...
								<div class="col">
									<div class="mb-3">
										<label for="shirtStomach" class="form-label">Stomach</label> <input
											type="text" class="form-control" id="shirtStomach"
