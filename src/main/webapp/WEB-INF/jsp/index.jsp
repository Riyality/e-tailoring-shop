                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar   bg-primary-transparent">
                                                        <svg class="fill-primary" style="height: 30px;" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                    ...
                                                    <h6 class="mb-0 text-default fw-medium ms-3 fs-18">Total Revenue</h6>
                                                </div>
                                                <span class="badge bg-primary-transparent ms-auto rounded-pill py-1">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="mb-0 text-default fw-medium ms-3 fs-18">Total Sales</h6>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="mb-0 text-default fw-medium ms-3 fs-18">Total Products</h6>
                                                </div>
