...
<div class="main-content app-content">
						...
						<div class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center">
								<span class="avatar   bg-primary-transparent"> <svg
										class="fill-primary" style="height: 30px;"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Total
									Revenue</h6>
							</div>
							<span
								class="badge bg-primary-transparent ms-auto rounded-pill py-1">
								<i class="ti ti-trending-up"></i> 20%
							</span>
						</div>
						<div class="mt-2">
							<h2 class="text-default mb-0 fs-24 fw-semibold">$26,35,262</h2>
				...
				<div class="card custom-card overflow-hidden">
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							...
							<span
								class="badge bg-secondary-transparent ms-auto rounded-pill py-1">
								<i class="ti ti-trending-up"></i> 1.8%
							</span>
						</div>
						<div class="mt-2">
							<h2 class="text-default mb-0 fs-24 fw-semibold">$56,35,262</h2>
							<p class=" mb-0 text-muted">in last week</p>
						</div>
					</div>
				</div>
				...
				<div class="card custom-card overflow-hidden">
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							...
							<span
								class="badge bg-warning-transparent ms-auto rounded-pill py-1">
								<i class="ti ti-trending-up"></i> 1.8%
							</span>
						</div>
						<div class="mt-2">
							<h2 class="text-default mb-0 fs-24 fw-semibold">$4,262</h2>
							<p class=" mb-0 text-muted">in last week</p>
						</div>
					</div>
				</div>
    ...
    function addForm() {
        ...
        const newForm = `
            <form action="">
                <select id="dropdown">
                    <option value="">Shirt Type 1</option>
                    <option value="">Shirt Type 2</option>
                    <option value="">Shirt Type 3</option>
                    <option value="">Shirt Type 4</option>
                    <option value="">Shirt Type 5</option>
                    <option value="">Shirt Type 6</option>
                </select>
                <button type="button" onclick="addShirtType()">+</button>
            </form>
